...
sed -i "s|module_library : \".*\"|module_library : \"$CYBER_RT_STUDYING_PATH/install/examples/class03_different_component/class01_empty_component/lib/libtest_class03_loc.so\"|" \
"$CYBER_RT_STUDYING_PATH/install/examples/class03_different_component/class01_empty_component/dag/class03_loc.dag"

${CYBER_RT_STUDYING_PATH}/install/bin/mainboard \
    -d "$CYBER_RT_STUDYING_PATH/install/examples/class03_different_component/class01_empty_component/dag/class03_planning.dag" \
    -d "$CYBER_RT_STUDYING_PATH/install/examples/class03_different_component/class01_empty_component/dag/class03_loc.dag"
