...
# Update planning dag
sed -i "s|module_library : \".*\"|module_library : \"$CYBER_RT_STUDYING_PATH/install/examples/class03_different_component/class02_component_one_input/lib/libtest_class02_planning.so\"|" \
"$CYBER_RT_STUDYING_PATH/install/examples/class03_different_component/class02_component_one_input/dag/class02_planning.dag"
...
${CYBER_RT_STUDYING_PATH}/install/bin/mainboard \
    -d "$CYBER_RT_STUDYING_PATH/install/examples/class03_different_component/class02_component_one_input/dag/class02_loc.dag" \
    -d "$CYBER_RT_STUDYING_PATH/install/examples/class03_different_component/class02_component_one_input/dag/class02_planning.dag"
