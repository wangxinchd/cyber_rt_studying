...
void Participant::CreateFastRtpsParticipant(
  ...
  eprosima::fastdds::rtps::Locator stLocator;
  stLocator.port = send_port;
  attr.rtps.defaultUnicastLocatorList.push_back(stLocator);
  ...
  RETURN_IF(!(eprosima::fastrtps::rtps::IPLocator::setIPv4(locator, ip_env))); // by shelman
  ...
  RETURN_IF(!(eprosima::fastrtps::rtps::IPLocator::setIPv4(locator, "239.255.0.1"))); // by shelman
